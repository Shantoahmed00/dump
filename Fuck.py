...
def mr_error():
    ...
    if innocent == '':
        ...
        try:
            ...
            print(" %s[%s#%s] _______________________________________________________________________________"%(N,O,N));time.sleep(2)
            ...
            print(" %s[%s#%s] _______________________________________________________________________________"%(N,O,N))
...
def teman(nunu):
    ...
    try:
        ...
        os.system('echo "_______________________________________________________________________________" | lolcat -a -d 2 -8')
